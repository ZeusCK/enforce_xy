...
CREATE TABLE `sync_case` (
  ...
  `update_time` datetime NOT NULL COMMENT '当前操作时间',
  PRIMARY KEY (`case_key`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ----------------------------
INSERT INTO `sync_case` VALUES ('case_201706', '20170623093621_086338_4115', '3', '2017-08-09 15:13:36');
...
-- ----------------------------
INSERT INTO `sync_case_video` VALUES ('case_video_201706', 'TA00716_086338_20170623093621.MOV', '1', '2017-08-09 15:13:36');
...
CREATE TABLE `sync_employee` (
  ...
  `code` varchar(32) NOT NULL DEFAULT '无' COMMENT '警员编号',
  `status` int(1) NOT NULL COMMENT '1:增加;2:删除;3:修改',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
