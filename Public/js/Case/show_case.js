                                ...
                                formatter: function(value, row, index) {
                                    ...
                                    if (row.source == "3" || row.source == "2") {
                                        return (
                                            ...
                                            "','" +
                                            row.wjbh +
                                            '\',\'#video_datagrid\')" name="sc"></a><a href="javascript:void(0)" onclick="module.pack_pop(this,\'' +
                                            row.start_time +
                                            "','" +
                                            row.wjbh +
                                            '\',1)" name="cf" ></a>'
                                ...
                                formatter: function(value, row, index) {
                                    ...
                                    if (row.source == "3" || row.source == "2") {
                                        return (
                                            ...
                                            "','" +
                                            row.wjbh +
                                            '\',\'#video_datagrid2\')" name="sc"></a><a href="javascript:void(0)" onclick="module.pack_pop(this,\'' +
                                            row.start_time +
                                            "','" +
                                            row.wjbh +
                                            '\',1)" name="cf" ></a>'
